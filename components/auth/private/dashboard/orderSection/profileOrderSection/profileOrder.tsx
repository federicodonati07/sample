...
import {
  ...
  DialogTitle,
  DialogTrigger
} from "@/components/ui/dialog"; // Cambiato da Sheet a Dialog
...
const ProfileOrder = ({ open, onOpenChange, uuid, orders }) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-gray-900 text-slate-50 flex flex-col justify-center items-center">
                <DialogHeader className="border-b border-slate-50 mb-6">
                    <DialogTitle className="text-slate-50 text-3xl font-bold">Your Orders</DialogTitle>
